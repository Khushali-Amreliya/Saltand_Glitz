...
const Productdetails = () => {
    ...
    const cartItem = {  
        id,
        title,
        price: adjustedPrice, // Add the confirmed adjusted price
        image01,
        totalprice: adjustedPrice, // Total price should reflect the customizations
        selectedSize,
        confirmedMetal,
...
//             id,
//             title,
//             price: adjustedPrice, // Use the final adjusted price
//             image01,
//             size: selectedSize,
//             metal: selectedMetal,
...
//     const metalOptions = useMemo(() => [
//         { metal: '18KT Yellow Gold', price: Math.round(price * 1.10) },
//         { metal: '14KT White Gold', price: price },
//         { metal: '16KT Rose Gold', price: Math.round(price * 1.07) }
//     ], [price]);
    
//     const diamondOptions = [
//         { quality: "IJ-SI", status: "Only 4 left!", price: Math.round(price * 1.02) },
//         { quality: "GH-VS", status: "Made to Order", price: Math.round(price * 1.04) },
//         { quality: "GH-VVS", status: "Made to Order", price: Math.round(price * 1.06) },
//         { quality: "EF-VVS", status: "Made to Order", price: Math.round(price * 1.08) },
//         { quality: "GH-SI", status: "In Stock!", price: price }
//     ];

//     const [selectedMetal, setSelectedMetal] = useState(metalOptions[1].metal);
//     const [confirmedMetal, setConfirmedMetal] = useState(metalOptions[1].metal);

//     const [selectedDiamondQuality, setSelectedDiamondQuality] = useState(diamondOptions[4].quality);
//     const [confirmedDiamondQuality, setConfirmedDiamondQuality] = useState(diamondOptions[4].quality);

//     // Load saved settings on component mount
//     useEffect(() => {
//         const savedSelections = JSON.parse(localStorage.getItem('productSelections'));
//         if (savedSelections) {
//             setSelectedSize(savedSelections.size || sizeOptions[3].size);
//             setConfirmedMetal(savedSelections.metal || metalOptions[1].metal);
//             setConfirmedDiamondQuality(savedSelections.quality || diamondOptions[4].quality);
//             setAdjustedPrice(savedSelections.price || price);
//         }
//     }, [price, sizeOptions, metalOptions, diamondOptions]);
...
//         // Save confirmed selection and price to localStorage
//         localStorage.setItem('productSelections', JSON.stringify({
//             size: selectedSize,
//             metal: selectedMetal,
//             quality: selectedDiamondQuality,
//             price: tempPrice
//         }));
//     };
//     return (
...
//                                     <button className='float-end' data-bs-toggle="offcanvas" data-bs-target="#offcanvassize" aria-controls="offcanvassize">CUSTOMISE</button>
//                                 </p> */}
//                                 <p className="d-flex align-items-center customize_sec bg-warning">
//                                     <div className="w-25 border-end px-2 py-1 bg-white" style={{ borderRadius: "10px 0px 0px 10px" }}>
//                                         <small className="text-muted">Size</small>
//                                         <p className="fw-bold mb-0">{selectedSize ? `${selectedSize} inches` : "Select Size"}</p>
//                                     </div>
...
//                                 </button>
//                             </p> */}
//                                 <div className="d-flex align-items-center customize_sec bg-warning container">
//                                     <div className="row">
//                                         <div className="col-4 w-25 border-end bg-white" style={{ borderRadius: "10px 0px 0px 10px" }}>
//                                             <small className="text-muted">Size</small>
//                                             <p className="fw-bold mb-0">{selectedSize ? `${selectedSize} inches` : "Select Size"}</p>
//                                         </div>
//                                         <div className="col-4 w-25 border-end px-2 py-1 bg-white">
//                                             <small className="text-muted">Metal</small>
//                                             <p className="fw-bold mb-0">{confirmedMetal}</p>
//                                         </div>
//                                         <div className="col-4 w-25 border-end px-2 py-1 bg-white">
