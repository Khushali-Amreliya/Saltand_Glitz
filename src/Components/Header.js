    ...
    useEffect(() => {
        const fetchLatestProducts = async () => {
            ...
            try {
                ...
                const response = await axios.post("https://saltandglitz-api.vercel.app/v1/search/searchProduct", { query: "earring" });
                // console.log(response);
                ...
                setProducts(productList.slice(8, 16));
                setDefaultProducts(productList.slice(8, 16));
            } catch (error) {
