...
const Rings = () => {
    ...
    const getUploadData = async () => {
        ...
        try {
            ...
            const categoryProducts = response.data.filter(item => item.category === "Ring");
    ...
    const applyFilters = async (appliedFilters) => {
        ...
        try {
            ...
            const filteredProducts = response.data.updatedProducts.filter(item => item.category === "Ring");
